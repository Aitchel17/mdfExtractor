function io_croptiff(raw_path, save_path, row_range, col_range, n_out, resolution, unit)
...
%      unit        1 x 3 string   the unit of each, e.g. ["um" "um" "sec"]
    frame_size = [row_range(2)-row_range(1)+1, col_range(2)-col_range(1)+1];
    [out_handle, out_tags] = io_savetiff_open(save_path, frame_size, n_out, 1, resolution, unit);
