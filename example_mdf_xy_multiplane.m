...
%%
file1 = file1.updatestate('num_plane',2,"loadstart",3); % set loading parameter
[file1, d] = file1.demoload(2,1); % (clear img channel, clear plane)
file1 = file1.demomotion(d);

% You can open multiple files and process user interaction at the beginning 
% file2 = file2.updatestate('num_plane',2,"loadstart",3); % 
% [file2, d] = file2.demoload(2,1); file2 = file2.demomotion(d);
...
file1 = file1.updatestate('groupz',1); % change frame averaging required for dft correction 
...
file1 = file1.updatestate('plane2read',2); % update loading parameter to other imaging plane 
